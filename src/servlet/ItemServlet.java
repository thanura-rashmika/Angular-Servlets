                ...
                try {
                    ...
                    if(add){
                        ...
                        JsonObject forCommonResponse = new JsonResponseGenerator()
                                .getForCommonResponse(Constants.ADDED, "Item is added successfully !");
            ...
            case "update":
                ...
                try {
                    ...
                    if(add){
                        resp.setStatus(200);
                        JsonObject forCommonResponse = new JsonResponseGenerator()
                                .getForCommonResponse(Constants.ADDED, "Item is updated successfully !");
                        resp.getWriter().println(forCommonResponse);
                        return;
                    }else {
            ...
            case "delete":
                ...
                try {
                    ...
                    if(delete){
                        resp.setStatus(200);
                        JsonObject forCommonResponse = new JsonResponseGenerator()
                                .getForCommonResponse(Constants.DELETED, "Item is deleted !");
                        resp.getWriter().println(forCommonResponse);
                        return;
                    }else {
